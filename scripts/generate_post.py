...
結尾刻意留白，讓讀者好奇心爆發——「然後呢？」
絕對不要揭露結局、寓意、或任何教訓。
語氣像在朋友耳邊說「欸你知道嗎，有一個超扯的故事…」然後突然被打斷。
結尾用一句話暗示「最精彩的在後面」，引導點進連結。
""",
    },
    {
        "name": "金句型",
...
讓讀者感受到這句金句的力量，但想知道背後的故事是什麼。
金句要原創，不要照抄寓意原文，要更精煉、更有記憶點。
結尾暗示「這句話背後有一個兩千年前的故事」引導點入。
""",
    },
    {
        "name": "對比型",
...
簡單暗示「兩千年前有個人也面對了同樣的問題」，但不說他怎麼解決的。
故事只提一兩句設定，完全不透露結局。
讓讀者帶著自己的答案點進來，看看古人的答案是什麼。
""",
    },
    {
        "name": "極短型",
...
用最少的字傳達最大的好奇心。
可以是：一個矛盾的場景 + 一句懸念 + 留白。
或是：一句令人困惑的描述 + 暗示故事裡有答案。
像俳句一樣，少即是多。每個字都要勾起好奇心。
絕對不要講完故事，只給一個「鉤子」。
""",
    },
    {
        "name": "故事型",
        "instruction": """
像跟朋友在咖啡廳聊天一樣，生動地說這個故事——但只說到高潮前。
用口語化的方式講述開場和發展，加入自己的吐槽、感嘆。
可以用「我跟你說」「你猜怎麼著」「最扯的是」這類口語。
講到最關鍵的轉折就停住，說「後面的發展你自己去看比較有感覺」。
不要講結局，不要講寓意，不要說教。讓讀者自己去體驗。
""",
    },
]
...
10. 每篇貼文必須給人「不點進去會錯過什麼」的 FOMO 感
